 ...
 * - Uses the same typography + mobile scaling logic as the Hero Banner
 */
function hmpro_header_bg_banner_is_enabled() {
	...
	// If homepage hero is enabled, prefer the hero and avoid stacking two banners.
	if ( is_front_page() && (int) get_theme_mod( 'hmpro_transparent_header_home', 0 ) === 1 ) {
		return false;
	}
	return true;
}
